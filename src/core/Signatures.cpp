...
void SignatureRegistry::registerSignatures() {
    ...
    */
    ...
    signatures.insert(std::make_pair("ScreenContext->tessellator", std::make_unique<Signature>("48 8B 9A ? ? ? ? C6 44 24 ? ? 41 B9 04 00 00 00 41 B0 01 48 8B CB E8 ? ? ? ? 0F 57 DB", 0, 3)));
